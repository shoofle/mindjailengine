...
import linearsortsearch as linearsortsearch
...
lss_sq_average = lss_sq / N_loops
lss_stdev = math.sqrt( lss_sq_average - lss_average**2 )
tree_time_average = tree_time / N_loops
tree_time_sq_average = tree_time_sq / N_loops
tree_time_stdev = math.sqrt( tree_time_sq_average - tree_time_average**2 )
tree_build_average = tree_build / N_loops
tree_build_sq_average = tree_build_sq / N_loops
tree_build_stdev = math.sqrt( tree_build_sq_average - tree_build_average**2 )
tree_search_average = tree_search / N_loops
tree_search_sq_average = tree_search_sq / N_loops
tree_search_stdev = math.sqrt( tree_search_sq_average - tree_search_average**2 )
print "Ran {0} tests with {1} randomly-generated circles.".format(N_loops, N_items)
print "Sort search time: {0:.4f} +/- {1:.4f}".format(lss_average,lss_stdev)
print "Tree search time: {0:.4f} +/- {1:.4f}".format(tree_time_average,tree_time_stdev)
print ""
print "Average tree-build time: {0:.4f} +/- {1:.4f}".format(tree_build_average,tree_build_stdev)
print "Average tree-search time: {0:.4f} +/- {1:.4f}".format(tree_search_average,tree_search_stdev)
print ""
...
print "Took {0:.4f} seconds to sortsearch.".format(lsstime)
print "Took {0:.4f} seconds to quadtree search.".format(quadtime)
