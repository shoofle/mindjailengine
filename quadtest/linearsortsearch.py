...
def collisions(input_list):
	...
	for index in index_list:
		index_minimum = ascending_minimum.index(index)
		index_maximum = descending_maximum.index(index)
		...
		for other_index in ascending_minimum[index_minimum:]:
			...
			if intersects(this_object, other_object): # Same dichotomy as before.
		...
		for other_index in descending_maximum[index_maximum:]:
			if other_index == index: continue
			other_object = get_object(other_index)
